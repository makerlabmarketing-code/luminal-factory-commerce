...
test("Hero 3D stays an idle desktop enhancement while ambient and reactive light stay separated", () => {
  ...
  assert.match(heroStage, /radial-gradient\(ellipse at \$\{xPercent\}% \$\{yPercent\}%/);

...
Status: `AWAITING_RAFFLE_SCHEMA_01`
...
- [ ] R004 Author the exact migration, rollback validation, and postflight.
- [ ] R005 Add static migration/RLS/grant/idempotency/concurrency tests.
- [ ] R006 Refresh generated database types from the reviewed schema boundary.
- [ ] R007 Implement the public raffle detail service and `/raffle/[slug]` route.
- [ ] R008 Implement the default-off server-only raffle entry adapter and
  request boundary.
- [ ] R009 Implement the accessible guest-entry form and truthful result states.
- [ ] R010 Run `npm run check` and disabled-runtime route/security verification.
